...
func (p *PrepareCraftingGrid) Id() int { return 1 }
func (p *PrepareCraftingGrid) Write(ww io.Writer) (err error) {
	var tmp [2]byte
	tmp[0] = byte(p.WindowID >> 0)
	if _, err = ww.Write(tmp[:1]); err != nil {
		return
	}
	tmp[0] = byte(p.ActionNumber >> 8)
	tmp[1] = byte(p.ActionNumber >> 0)
	if _, err = ww.Write(tmp[:2]); err != nil {
		return
	}
	tmp[0] = byte(int16(len(p.ReturnEntries)) >> 8)
	tmp[1] = byte(int16(len(p.ReturnEntries)) >> 0)
	if _, err = ww.Write(tmp[:2]); err != nil {
		return
	}
	for tmp0 := range p.ReturnEntries {
		if err = p.ReturnEntries[tmp0].Item.Serialize(ww); err != nil {
			return
		}
		tmp[0] = byte(p.ReturnEntries[tmp0].CSlot >> 0)
		if _, err = ww.Write(tmp[:1]); err != nil {
			return
		}
		tmp[0] = byte(p.ReturnEntries[tmp0].PSlot >> 0)
		if _, err = ww.Write(tmp[:1]); err != nil {
			return
		}
	}
	tmp[0] = byte(int16(len(p.PreparedEntries)) >> 8)
	tmp[1] = byte(int16(len(p.PreparedEntries)) >> 0)
	if _, err = ww.Write(tmp[:2]); err != nil {
		return
	}
	for tmp1 := range p.PreparedEntries {
		if err = p.PreparedEntries[tmp1].Item.Serialize(ww); err != nil {
			return
		}
		tmp[0] = byte(p.PreparedEntries[tmp1].CSlot >> 0)
		if _, err = ww.Write(tmp[:1]); err != nil {
			return
		}
		tmp[0] = byte(p.PreparedEntries[tmp1].PSlot >> 0)
		if _, err = ww.Write(tmp[:1]); err != nil {
			return
		}
	}
...
func (p *PrepareCraftingGrid) Read(rr io.Reader) (err error) {
	var tmp [2]byte
	...
	p.ActionNumber = int16((uint16(tmp[1]) << 0) | (uint16(tmp[0]) << 8))
	var tmp0 int16
	if _, err = rr.Read(tmp[:2]); err != nil {
		return
	}
	...
	p.ReturnEntries = make([]ReturnEntry, tmp0)
	for tmp1 := range p.ReturnEntries {
		if err = p.ReturnEntries[tmp1].Item.Deserialize(rr); err != nil {
			return
		}
		if _, err = rr.Read(tmp[:1]); err != nil {
			return
	...
	tmp2 = int16((uint16(tmp[1]) << 0) | (uint16(tmp[0]) << 8))
	...
	p.PreparedEntries = make([]PrepareEntry, tmp2)
	for tmp3 := range p.PreparedEntries {
		if err = p.PreparedEntries[tmp3].Item.Deserialize(rr); err != nil {
			return
		}
		if _, err = rr.Read(tmp[:1]); err != nil {
			return
...
func (t *TabComplete) Id() int { return 2 }
...
func (c *ChatMessage) Id() int { return 3 }
...
func (c *ClientStatus) Id() int { return 4 }
...
func (c *ClientSettings) Id() int { return 5 }
...
func (c *ConfirmTransactionServerbound) Id() int { return 6 }
...
func (e *EnchantItem) Id() int { return 7 }
...
func (c *ClickWindow) Id() int { return 8 }
...
func (c *CloseWindow) Id() int { return 9 }
...
func (p *PluginMessageServerbound) Id() int { return 10 }
...
func (u *UseEntity) Id() int { return 11 }
...
func (k *KeepAliveServerbound) Id() int { return 12 }
...
func (p *Player) Id() int { return 13 }
...
func (p *PlayerPosition) Id() int { return 14 }
...
func (p *PlayerPositionLook) Id() int { return 15 }
...
func (p *PlayerLook) Id() int { return 16 }
...
func (v *VehicleDrive) Id() int { return 17 }
...
func (s *SteerBoat) Id() int { return 18 }
...
func init() {
	...
	packets[lib.Play][lib.Serverbound][1] = func() lib.Packet { return &PrepareCraftingGrid{} }
	packets[lib.Play][lib.Serverbound][2] = func() lib.Packet { return &TabComplete{} }
	packets[lib.Play][lib.Serverbound][3] = func() lib.Packet { return &ChatMessage{} }
	packets[lib.Play][lib.Serverbound][4] = func() lib.Packet { return &ClientStatus{} }
	packets[lib.Play][lib.Serverbound][5] = func() lib.Packet { return &ClientSettings{} }
	packets[lib.Play][lib.Serverbound][6] = func() lib.Packet { return &ConfirmTransactionServerbound{} }
	packets[lib.Play][lib.Serverbound][7] = func() lib.Packet { return &EnchantItem{} }
	packets[lib.Play][lib.Serverbound][8] = func() lib.Packet { return &ClickWindow{} }
	packets[lib.Play][lib.Serverbound][9] = func() lib.Packet { return &CloseWindow{} }
	packets[lib.Play][lib.Serverbound][10] = func() lib.Packet { return &PluginMessageServerbound{} }
	packets[lib.Play][lib.Serverbound][11] = func() lib.Packet { return &UseEntity{} }
	packets[lib.Play][lib.Serverbound][12] = func() lib.Packet { return &KeepAliveServerbound{} }
	packets[lib.Play][lib.Serverbound][13] = func() lib.Packet { return &Player{} }
	packets[lib.Play][lib.Serverbound][14] = func() lib.Packet { return &PlayerPosition{} }
	packets[lib.Play][lib.Serverbound][15] = func() lib.Packet { return &PlayerPositionLook{} }
	packets[lib.Play][lib.Serverbound][16] = func() lib.Packet { return &PlayerLook{} }
	packets[lib.Play][lib.Serverbound][17] = func() lib.Packet { return &VehicleDrive{} }
	packets[lib.Play][lib.Serverbound][18] = func() lib.Packet { return &SteerBoat{} }
