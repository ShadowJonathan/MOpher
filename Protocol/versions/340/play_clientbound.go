...
type Statistics struct {
	Statistics []Statistic `length:"lib.VarInt"`
}
...
type TabCompleteReply struct {
	Count   lib.VarInt
	Matches []string `length:"lib.VarInt"`
}
...
type MultiBlockChange struct {
	ChunkX, ChunkZ int32
	Records        []BlockChangeRecord `length:"lib.VarInt"`
}
...
type ChunkData struct {
	...
	New            bool
	BitMask        lib.VarInt
	Data           []byte        `length:"lib.VarInt" nolimit:"true"`
	BlockEntities  []BlockEntity `length:"lib.VarInt"`
}
...
type Maps struct {
	...
	Icons            []MapIcon `length:"lib.VarInt"`
	Columns          byte
	Rows             byte      `if:".Columns>0"`
	X                byte      `if:".Columns>0"`
	Z                byte      `if:".Columns>0"`
	Data             []byte    `if:".Columns>0" length:"lib.VarInt"`
}
...
//
// This is a Minecraft packet
type CraftReceipeResponse struct {
	WindowID byte
	Receipe  lib.VarInt
}
...
type PlayerInfo struct {
	Action  lib.VarInt
	Players []PlayerDetail `length:"lib.VarInt"`
}
...
type PlayerDetail struct {
	...
	Properties  []PlayerProperty    `length:"lib.VarInt" if:"..Action==0"`
...
type UnlockReceipes struct {
	...
	ReceipeIDs         []lib.VarInt `length:"lib.VarInt"`
	AllReceipeIDs      []lib.VarInt `length:"lib.VarInt" if:".Action == 0"`
}
...
type EntityDestroy struct {
	EntityIDs []lib.VarInt `length:"lib.VarInt"`
}
...
type Passengers struct {
	ID         lib.VarInt
	Passengers []lib.VarInt `length:"lib.VarInt"`
}
...
type Teams struct {
	...
	Players           []string `length:"lib.VarInt" if:".Mode == 0 .Mode == 3 .Mode == 4"`
}
...
type Advancements struct {
	Clear                         bool
	AdvancementMapping            []AdvancementMappingItem `length:"lib.VarInt"`
	RemovedAdvancementIdentifiers []string                 `length:"lib.VarInt"`
	ProgressMapping               []ProgressMappingItem    `length:"lib.VarInt"`
}
...
type Advancement struct {
	...
	Criteria     []string                  `length:"lib.VarInt"`
	Requirements []AdvancementRequirements `length:"lib.VarInt"`
}
...
type AdvancementRequirements struct {
	Requirement []string `length:"lib.VarInt"`
}
...
type AdvancementProgress struct {
	Criteria []ProgressCriteria `length:"lib.VarInt"`
}
...
type EntityProperty struct {
	Key       string
	Value     float64
	Modifiers []PropertyModifier `length:"lib.VarInt"`
}
