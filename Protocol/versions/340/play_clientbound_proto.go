...
func (e *Entity) Id() int { return 37 }
...
func (c *CraftReceipeResponse) Id() int { return 43 }
func (c *CraftReceipeResponse) Write(ww io.Writer) (err error) {
	var tmp [1]byte
...
func (c *CraftReceipeResponse) Read(rr io.Reader) (err error) {
	var tmp [1]byte
	if _, err = rr.Read(tmp[:1]); err != nil {
		return
	}
...
func (p *PlayerAbilities) Id() int { return 44 }
...
func (c *CombatEvent) Id() int { return 45 }
...
func (p *PlayerInfo) Id() int { return 46 }
...
func (t *TeleportPlayer) Id() int { return 47 }
...
func (e *EntityUsedBed) Id() int { return 48 }
...
func (u *UnlockReceipes) Id() int { return 49 }
func (u *UnlockReceipes) Write(ww io.Writer) (err error) {
	if err = lib.WriteVarInt(ww, u.Action); err != nil {
		return
	}
	if err = lib.WriteBool(ww, u.CraftingBookOpen); err != nil {
		return
	}
	if err = lib.WriteBool(ww, u.FilteringCraftable); err != nil {
		return
	}
	if err = lib.WriteVarInt(ww, lib.VarInt(len(u.ReceipeIDs))); err != nil {
		return
	}
	for tmp0 := range u.ReceipeIDs {
		if err = lib.WriteVarInt(ww, u.ReceipeIDs[tmp0]); err != nil {
			return
		}
	}
	if u.Action == 0 {
		if err = lib.WriteVarInt(ww, lib.VarInt(len(u.AllReceipeIDs))); err != nil {
			return
		}
		for tmp1 := range u.AllReceipeIDs {
			if err = lib.WriteVarInt(ww, u.AllReceipeIDs[tmp1]); err != nil {
				return
			}
		}
	}
...
func (u *UnlockReceipes) Read(rr io.Reader) (err error) {
	if u.Action, err = lib.ReadVarInt(rr); err != nil {
		return
	}
	if u.CraftingBookOpen, err = lib.ReadBool(rr); err != nil {
		return
	}
	if u.FilteringCraftable, err = lib.ReadBool(rr); err != nil {
		return
	}
	var tmp0 lib.VarInt
	if tmp0, err = lib.ReadVarInt(rr); err != nil {
	...
	u.ReceipeIDs = make([]lib.VarInt, tmp0)
	for tmp1 := range u.ReceipeIDs {
		if u.ReceipeIDs[tmp1], err = lib.ReadVarInt(rr); err != nil {
			return
		}
	}
	if u.Action == 0 {
		...
		u.AllReceipeIDs = make([]lib.VarInt, tmp2)
		for tmp3 := range u.AllReceipeIDs {
			if u.AllReceipeIDs[tmp3], err = lib.ReadVarInt(rr); err != nil {
				return
			}
		}
	}
...
func (e *EntityDestroy) Id() int { return 50 }
...
func (e *EntityRemoveEffect) Id() int { return 51 }
...
func (r *ResourcePackSend) Id() int { return 52 }
...
func (r *Respawn) Id() int { return 53 }
...
func (e *EntityHeadLook) Id() int { return 54 }
...
func (s *SelectAdvancementTab) Id() int { return 55 }
func (s *SelectAdvancementTab) Write(ww io.Writer) (err error) {
	if err = lib.WriteBool(ww, s.HasID); err != nil {
		return
	}
	if s.HasID == true {
		if err = lib.WriteString(ww, s.Identifier); err != nil {
			return
		}
	}
	return
...
func (s *SelectAdvancementTab) Read(rr io.Reader) (err error) {
	if s.HasID, err = lib.ReadBool(rr); err != nil {
		return
	}
	if s.HasID == true {
		if s.Identifier, err = lib.ReadString(rr); err != nil {
			return
		}
	}
	return
...
func (w *WorldBorder) Id() int { return 56 }
...
func (c *Camera) Id() int { return 57 }
...
func (s *SetCurrentHotbarSlot) Id() int { return 58 }
...
func (s *ScoreboardDisplay) Id() int { return 59 }
...
func (e *EntityMetadata) Id() int { return 60 }
...
func (e *EntityAttach) Id() int { return 61 }
...
func (e *EntityVelocity) Id() int { return 62 }
...
func (e *EntityEquipment) Id() int { return 63 }
...
func (s *SetExperience) Id() int { return 64 }
...
func (u *UpdateHealth) Id() int { return 65 }
...
func (s *ScoreboardObjective) Id() int { return 66 }
...
func (p *Passengers) Id() int { return 67 }
...
func (u *UpdateScore) Id() int { return 69 }
...
func (s *SpawnPosition) Id() int { return 70 }
...
func (t *TimeUpdate) Id() int { return 71 }
...
func (h *HardSoundEffect) Id() int { return 73 }
...
func (p *PlayerListHeaderFooter) Id() int { return 74 }
...
func (c *CollectItem) Id() int { return 75 }
...
func (e *EntityTeleport) Id() int { return 76 }
...
func (a *Advancements) Id() int { return 77 }
func (a *Advancements) Write(ww io.Writer) (err error) {
	var tmp [8]byte
	if err = lib.WriteBool(ww, a.Clear); err != nil {
		return
	}
	if err = lib.WriteVarInt(ww, lib.VarInt(len(a.AdvancementMapping))); err != nil {
		return
	}
	for tmp0 := range a.AdvancementMapping {
		if err = lib.WriteString(ww, a.AdvancementMapping[tmp0].Key); err != nil {
			return
		}
		if err = lib.WriteBool(ww, a.AdvancementMapping[tmp0].Value.HasParent); err != nil {
			return
		}
		if a.AdvancementMapping[tmp0].Value.HasParent == true {
			if err = lib.WriteString(ww, a.AdvancementMapping[tmp0].Value.ParentID); err != nil {
				return
			}
		}
		if err = lib.WriteBool(ww, a.AdvancementMapping[tmp0].Value.HasDisplay); err != nil {
			return
		}
		if a.AdvancementMapping[tmp0].Value.HasDisplay == true {
			var tmp1 []byte
			if tmp1, err = json.Marshal(&a.AdvancementMapping[tmp0].Value.DisplayData.Title); err != nil {
				return
			}
			tmp2 := string(tmp1)
			if err = lib.WriteString(ww, tmp2); err != nil {
				return
			}
			var tmp3 []byte
			if tmp3, err = json.Marshal(&a.AdvancementMapping[tmp0].Value.DisplayData.Description); err != nil {
				return
			}
			tmp4 := string(tmp3)
			if err = lib.WriteString(ww, tmp4); err != nil {
				return
			}
			if err = a.AdvancementMapping[tmp0].Value.DisplayData.Icon.Serialize(ww); err != nil {
				return
			}
			if err = lib.WriteVarInt(ww, a.AdvancementMapping[tmp0].Value.DisplayData.FrameType); err != nil {
				return
			}
			tmp[0] = byte(a.AdvancementMapping[tmp0].Value.DisplayData.Flags >> 24)
			tmp[1] = byte(a.AdvancementMapping[tmp0].Value.DisplayData.Flags >> 16)
			tmp[2] = byte(a.AdvancementMapping[tmp0].Value.DisplayData.Flags >> 8)
			tmp[3] = byte(a.AdvancementMapping[tmp0].Value.DisplayData.Flags >> 0)
			if _, err = ww.Write(tmp[:4]); err != nil {
				return
			}
			if a.AdvancementMapping[tmp0].Value.DisplayData.Flags&1 == 1 {
				if err = lib.WriteString(ww, a.AdvancementMapping[tmp0].Value.DisplayData.BackgroundTexture); err != nil {
					return
				}
			}
			tmp5 := math.Float32bits(a.AdvancementMapping[tmp0].Value.DisplayData.X)
			tmp[0] = byte(tmp5 >> 24)
			tmp[1] = byte(tmp5 >> 16)
			tmp[2] = byte(tmp5 >> 8)
			tmp[3] = byte(tmp5 >> 0)
			...
			tmp6 := math.Float32bits(a.AdvancementMapping[tmp0].Value.DisplayData.Y)
			tmp[0] = byte(tmp6 >> 24)
			tmp[1] = byte(tmp6 >> 16)
			tmp[2] = byte(tmp6 >> 8)
			tmp[3] = byte(tmp6 >> 0)
		...
		if err = lib.WriteVarInt(ww, lib.VarInt(len(a.AdvancementMapping[tmp0].Value.Criteria))); err != nil {
			return
		}
		for tmp7 := range a.AdvancementMapping[tmp0].Value.Criteria {
			if err = lib.WriteString(ww, a.AdvancementMapping[tmp0].Value.Criteria[tmp7]); err != nil {
				return
			}
		}
		if err = lib.WriteVarInt(ww, lib.VarInt(len(a.AdvancementMapping[tmp0].Value.Requirements))); err != nil {
			return
		}
		for tmp8 := range a.AdvancementMapping[tmp0].Value.Requirements {
			if err = lib.WriteVarInt(ww, lib.VarInt(len(a.AdvancementMapping[tmp0].Value.Requirements[tmp8].Requirement))); err != nil {
				return
			}
			for tmp9 := range a.AdvancementMapping[tmp0].Value.Requirements[tmp8].Requirement {
				if err = lib.WriteString(ww, a.AdvancementMapping[tmp0].Value.Requirements[tmp8].Requirement[tmp9]); err != nil {
					return
				}
			}
		}
	}
	if err = lib.WriteVarInt(ww, lib.VarInt(len(a.RemovedAdvancementIdentifiers))); err != nil {
		return
	}
	for tmp10 := range a.RemovedAdvancementIdentifiers {
		if err = lib.WriteString(ww, a.RemovedAdvancementIdentifiers[tmp10]); err != nil {
			return
		}
	}
	if err = lib.WriteVarInt(ww, lib.VarInt(len(a.ProgressMapping))); err != nil {
		return
	}
	for tmp11 := range a.ProgressMapping {
		if err = lib.WriteString(ww, a.ProgressMapping[tmp11].Key); err != nil {
			return
		}
		if err = lib.WriteVarInt(ww, lib.VarInt(len(a.ProgressMapping[tmp11].Value.Criteria))); err != nil {
			return
		}
		for tmp12 := range a.ProgressMapping[tmp11].Value.Criteria {
			if err = lib.WriteString(ww, a.ProgressMapping[tmp11].Value.Criteria[tmp12].Identifier); err != nil {
				return
			}
			if err = lib.WriteBool(ww, a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Archieved); err != nil {
				return
			}
			if a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Archieved == true {
				tmp[0] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 56)
				tmp[1] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 48)
				tmp[2] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 40)
				tmp[3] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 32)
				tmp[4] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 24)
				tmp[5] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 16)
				tmp[6] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 8)
				tmp[7] = byte(a.ProgressMapping[tmp11].Value.Criteria[tmp12].Progress.Date >> 0)
				if _, err = ww.Write(tmp[:8]); err != nil {
					return
				}
			}
...
func (a *Advancements) Read(rr io.Reader) (err error) {
	var tmp [8]byte
	if a.Clear, err = lib.ReadBool(rr); err != nil {
		return
	}
	var tmp0 lib.VarInt
	if tmp0, err = lib.ReadVarInt(rr); err != nil {
	...
	a.AdvancementMapping = make([]AdvancementMappingItem, tmp0)
	for tmp1 := range a.AdvancementMapping {
		if a.AdvancementMapping[tmp1].Key, err = lib.ReadString(rr); err != nil {
			return
		}
		if a.AdvancementMapping[tmp1].Value.HasParent, err = lib.ReadBool(rr); err != nil {
			return
		}
		if a.AdvancementMapping[tmp1].Value.HasParent == true {
			if a.AdvancementMapping[tmp1].Value.ParentID, err = lib.ReadString(rr); err != nil {
				return
			}
		}
		if a.AdvancementMapping[tmp1].Value.HasDisplay, err = lib.ReadBool(rr); err != nil {
			return
		}
		if a.AdvancementMapping[tmp1].Value.HasDisplay == true {
			var tmp2 string
			if tmp2, err = lib.ReadString(rr); err != nil {
				return err
			}
			if err = json.Unmarshal([]byte(tmp2), &a.AdvancementMapping[tmp1].Value.DisplayData.Title); err != nil {
				return
			}
			var tmp3 string
			if tmp3, err = lib.ReadString(rr); err != nil {
				return err
			}
			if err = json.Unmarshal([]byte(tmp3), &a.AdvancementMapping[tmp1].Value.DisplayData.Description); err != nil {
				return
			}
			if err = a.AdvancementMapping[tmp1].Value.DisplayData.Icon.Deserialize(rr); err != nil {
				return
			}
			if a.AdvancementMapping[tmp1].Value.DisplayData.FrameType, err = lib.ReadVarInt(rr); err != nil {
				return
			}
			if _, err = rr.Read(tmp[:4]); err != nil {
				return
			}
			a.AdvancementMapping[tmp1].Value.DisplayData.Flags = int32((uint32(tmp[3]) << 0) | (uint32(tmp[2]) << 8) | (uint32(tmp[1]) << 16) | (uint32(tmp[0]) << 24))
			if a.AdvancementMapping[tmp1].Value.DisplayData.Flags&1 == 1 {
				if a.AdvancementMapping[tmp1].Value.DisplayData.BackgroundTexture, err = lib.ReadString(rr); err != nil {
					return
				}
			}
			var tmp4 uint32
			...
			tmp4 = (uint32(tmp[3]) << 0) | (uint32(tmp[2]) << 8) | (uint32(tmp[1]) << 16) | (uint32(tmp[0]) << 24)
			a.AdvancementMapping[tmp1].Value.DisplayData.X = math.Float32frombits(tmp4)
			var tmp5 uint32
			if _, err = rr.Read(tmp[:4]); err != nil {
				return
			}
			tmp5 = (uint32(tmp[3]) << 0) | (uint32(tmp[2]) << 8) | (uint32(tmp[1]) << 16) | (uint32(tmp[0]) << 24)
			a.AdvancementMapping[tmp1].Value.DisplayData.Y = math.Float32frombits(tmp5)
		}
		var tmp6 lib.VarInt
		if tmp6, err = lib.ReadVarInt(rr); err != nil {
			return
		}
		...
		a.AdvancementMapping[tmp1].Value.Criteria = make([]string, tmp6)
		for tmp7 := range a.AdvancementMapping[tmp1].Value.Criteria {
			if a.AdvancementMapping[tmp1].Value.Criteria[tmp7], err = lib.ReadString(rr); err != nil {
				return
			}
		}
		var tmp8 lib.VarInt
		if tmp8, err = lib.ReadVarInt(rr); err != nil {
			return
		}
		...
		a.AdvancementMapping[tmp1].Value.Requirements = make([]AdvancementRequirements, tmp8)
		for tmp9 := range a.AdvancementMapping[tmp1].Value.Requirements {
			var tmp10 lib.VarInt
			if tmp10, err = lib.ReadVarInt(rr); err != nil {
				return
			}
			...
			a.AdvancementMapping[tmp1].Value.Requirements[tmp9].Requirement = make([]string, tmp10)
			for tmp11 := range a.AdvancementMapping[tmp1].Value.Requirements[tmp9].Requirement {
				if a.AdvancementMapping[tmp1].Value.Requirements[tmp9].Requirement[tmp11], err = lib.ReadString(rr); err != nil {
					return
				}
			}
		}
	}
	var tmp12 lib.VarInt
	if tmp12, err = lib.ReadVarInt(rr); err != nil {
		return
	}
	...
	a.RemovedAdvancementIdentifiers = make([]string, tmp12)
	for tmp13 := range a.RemovedAdvancementIdentifiers {
		if a.RemovedAdvancementIdentifiers[tmp13], err = lib.ReadString(rr); err != nil {
			return
		}
	}
	var tmp14 lib.VarInt
	if tmp14, err = lib.ReadVarInt(rr); err != nil {
		return
	}
	...
	a.ProgressMapping = make([]ProgressMappingItem, tmp14)
	for tmp15 := range a.ProgressMapping {
		if a.ProgressMapping[tmp15].Key, err = lib.ReadString(rr); err != nil {
			return
		}
		var tmp16 lib.VarInt
		if tmp16, err = lib.ReadVarInt(rr); err != nil {
			return
		}
		...
		a.ProgressMapping[tmp15].Value.Criteria = make([]ProgressCriteria, tmp16)
		for tmp17 := range a.ProgressMapping[tmp15].Value.Criteria {
			if a.ProgressMapping[tmp15].Value.Criteria[tmp17].Identifier, err = lib.ReadString(rr); err != nil {
				return
			}
			if a.ProgressMapping[tmp15].Value.Criteria[tmp17].Progress.Archieved, err = lib.ReadBool(rr); err != nil {
				return
			}
			if a.ProgressMapping[tmp15].Value.Criteria[tmp17].Progress.Archieved == true {
				if _, err = rr.Read(tmp[:8]); err != nil {
					return
				}
				a.ProgressMapping[tmp15].Value.Criteria[tmp17].Progress.Date = int64((uint64(tmp[7]) << 0) | (uint64(tmp[6]) << 8) | (uint64(tmp[5]) << 16) | (uint64(tmp[4]) << 24) | (uint64(tmp[3]) << 32) | (uint64(tmp[2]) << 40) | (uint64(tmp[1]) << 48) | (uint64(tmp[0]) << 56))
			}
		}
	}
	return
...
func (e *EntityProperties) Id() int { return 78 }
...
func (e *EntityEffect) Id() int { return 79 }
...
func init() {
	...
	packets[lib.Play][lib.Clientbound][37] = func() lib.Packet { return &Entity{} }
	packets[lib.Play][lib.Clientbound][38] = func() lib.Packet { return &EntityMove{} }
	packets[lib.Play][lib.Clientbound][39] = func() lib.Packet { return &EntityLookAndMove{} }
	packets[lib.Play][lib.Clientbound][40] = func() lib.Packet { return &EntityLook{} }
	...
	packets[lib.Play][lib.Clientbound][43] = func() lib.Packet { return &CraftReceipeResponse{} }
	packets[lib.Play][lib.Clientbound][44] = func() lib.Packet { return &PlayerAbilities{} }
	packets[lib.Play][lib.Clientbound][45] = func() lib.Packet { return &CombatEvent{} }
	packets[lib.Play][lib.Clientbound][46] = func() lib.Packet { return &PlayerInfo{} }
	packets[lib.Play][lib.Clientbound][47] = func() lib.Packet { return &TeleportPlayer{} }
	packets[lib.Play][lib.Clientbound][48] = func() lib.Packet { return &EntityUsedBed{} }
	packets[lib.Play][lib.Clientbound][49] = func() lib.Packet { return &UnlockReceipes{} }
	packets[lib.Play][lib.Clientbound][50] = func() lib.Packet { return &EntityDestroy{} }
	packets[lib.Play][lib.Clientbound][51] = func() lib.Packet { return &EntityRemoveEffect{} }
	packets[lib.Play][lib.Clientbound][52] = func() lib.Packet { return &ResourcePackSend{} }
	packets[lib.Play][lib.Clientbound][53] = func() lib.Packet { return &Respawn{} }
	packets[lib.Play][lib.Clientbound][54] = func() lib.Packet { return &EntityHeadLook{} }
	packets[lib.Play][lib.Clientbound][55] = func() lib.Packet { return &SelectAdvancementTab{} }
	packets[lib.Play][lib.Clientbound][56] = func() lib.Packet { return &WorldBorder{} }
	packets[lib.Play][lib.Clientbound][57] = func() lib.Packet { return &Camera{} }
	packets[lib.Play][lib.Clientbound][58] = func() lib.Packet { return &SetCurrentHotbarSlot{} }
	packets[lib.Play][lib.Clientbound][59] = func() lib.Packet { return &ScoreboardDisplay{} }
	packets[lib.Play][lib.Clientbound][60] = func() lib.Packet { return &EntityMetadata{} }
	packets[lib.Play][lib.Clientbound][61] = func() lib.Packet { return &EntityAttach{} }
	packets[lib.Play][lib.Clientbound][62] = func() lib.Packet { return &EntityVelocity{} }
	packets[lib.Play][lib.Clientbound][63] = func() lib.Packet { return &EntityEquipment{} }
	packets[lib.Play][lib.Clientbound][64] = func() lib.Packet { return &SetExperience{} }
	packets[lib.Play][lib.Clientbound][65] = func() lib.Packet { return &UpdateHealth{} }
	packets[lib.Play][lib.Clientbound][66] = func() lib.Packet { return &ScoreboardObjective{} }
	packets[lib.Play][lib.Clientbound][67] = func() lib.Packet { return &Passengers{} }
	packets[lib.Play][lib.Clientbound][68] = func() lib.Packet { return &Teams{} }
	packets[lib.Play][lib.Clientbound][69] = func() lib.Packet { return &UpdateScore{} }
	packets[lib.Play][lib.Clientbound][70] = func() lib.Packet { return &SpawnPosition{} }
	packets[lib.Play][lib.Clientbound][71] = func() lib.Packet { return &TimeUpdate{} }
	packets[lib.Play][lib.Clientbound][72] = func() lib.Packet { return &Title{} }
	packets[lib.Play][lib.Clientbound][73] = func() lib.Packet { return &HardSoundEffect{} }
	packets[lib.Play][lib.Clientbound][74] = func() lib.Packet { return &PlayerListHeaderFooter{} }
	packets[lib.Play][lib.Clientbound][75] = func() lib.Packet { return &CollectItem{} }
	packets[lib.Play][lib.Clientbound][76] = func() lib.Packet { return &EntityTeleport{} }
	packets[lib.Play][lib.Clientbound][77] = func() lib.Packet { return &Advancements{} }
	packets[lib.Play][lib.Clientbound][78] = func() lib.Packet { return &EntityProperties{} }
	packets[lib.Play][lib.Clientbound][79] = func() lib.Packet { return &EntityEffect{} }
}
