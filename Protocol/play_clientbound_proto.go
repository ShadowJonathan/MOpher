...
func (t *TabCompleteReply) write(ww io.Writer) (err error) {
	if err = WriteVarInt(ww, t.Count); err != nil {
		return
	}
...
func (t *TabCompleteReply) read(rr io.Reader) (err error) {
	if t.Count, err = ReadVarInt(rr); err != nil {
		return
	}
	var tmp0 VarInt
	if tmp0, err = ReadVarInt(rr); err != nil {
...
func (s *SoundEffect) write(ww io.Writer) (err error) {
	...
	if err = WriteVarInt(ww, s.Catargory); err != nil {
		return
	}
	tmp[0] = byte(s.X >> 24)
	tmp[1] = byte(s.X >> 16)
...
func (s *SoundEffect) read(rr io.Reader) (err error) {
	...
	if s.Catargory, err = ReadVarInt(rr); err != nil {
		return
	}
	if _, err = rr.Read(tmp[:4]); err != nil {
		return
...
func (c *ChunkData) write(ww io.Writer) (err error) {
	...
	for tmp0 := range c.BlockEntities {
		if err = WriteNBT(ww, c.BlockEntities[tmp0].NBT); err != nil {
			return
		}
	}
	return
...
func (c *ChunkData) read(rr io.Reader) (err error) {
	...
	for tmp2 := range c.BlockEntities {
		if c.BlockEntities[tmp2].NBT, err = ReadNBT(rr); err != nil {
			return
		}
	}
	return
...
func (t *TeleportPlayer) write(ww io.Writer) (err error) {
	...
	if err = WriteVarInt(ww, t.TPID); err != nil {
		return
	}
	return
}
func (t *TeleportPlayer) read(rr io.Reader) (err error) {
	...
	if t.TPID, err = ReadVarInt(rr); err != nil {
		return
	}
	return
}
...
func (p *Passengers) write(ww io.Writer) (err error) {
	if err = WriteVarInt(ww, p.ID); err != nil {
		return
	}
	if err = WriteVarInt(ww, VarInt(len(p.Passengers))); err != nil {
		return
	}
	for tmp0 := range p.Passengers {
		if err = WriteVarInt(ww, p.Passengers[tmp0]); err != nil {
			return
		}
	}
	return
...
func (p *Passengers) read(rr io.Reader) (err error) {
	if p.ID, err = ReadVarInt(rr); err != nil {
		return
	}
	var tmp0 VarInt
	if tmp0, err = ReadVarInt(rr); err != nil {
	...
	p.Passengers = make([]VarInt, tmp0)
	for tmp1 := range p.Passengers {
		if p.Passengers[tmp1], err = ReadVarInt(rr); err != nil {
			return
		}
	}
	return
...
func (h *HardSoundEffect) write(ww io.Writer) (err error) {
	var tmp [4]byte
	if err = WriteVarInt(ww, h.ID); err != nil {
		return
	}
	if err = WriteVarInt(ww, h.Cat); err != nil {
		return
	}
	tmp[0] = byte(h.X >> 24)
	tmp[1] = byte(h.X >> 16)
...
func (h *HardSoundEffect) read(rr io.Reader) (err error) {
	var tmp [4]byte
	if h.ID, err = ReadVarInt(rr); err != nil {
		return
	}
	if h.Cat, err = ReadVarInt(rr); err != nil {
		return
	}
	if _, err = rr.Read(tmp[:4]); err != nil {
		return
...
func (c *CollectItem) write(ww io.Writer) (err error) {
	...
	if err = WriteVarInt(ww, c.PickUpCount); err != nil {
		return
	}
	return
}
func (c *CollectItem) read(rr io.Reader) (err error) {
	...
	if c.PickUpCount, err = ReadVarInt(rr); err != nil {
		return
	}
	return
}
...
func init() {
	...
	packetCreator[Play][clientbound][25] = func() Packet { return &SoundEffect{} }
	packetCreator[Play][clientbound][26] = func() Packet { return &Disconnect{} }
	packetCreator[Play][clientbound][27] = func() Packet { return &EntityAction{} }
	packetCreator[Play][clientbound][28] = func() Packet { return &Explosion{} }
	packetCreator[Play][clientbound][29] = func() Packet { return &ChunkUnload{} }
	...
	packetCreator[Play][clientbound][35] = func() Packet { return &JoinGame{} }
	packetCreator[Play][clientbound][36] = func() Packet { return &Maps{} }
	packetCreator[Play][clientbound][37] = func() Packet { return &EntityMove{} }
	packetCreator[Play][clientbound][38] = func() Packet { return &EntityLookAndMove{} }
	packetCreator[Play][clientbound][39] = func() Packet { return &EntityLook{} }
	packetCreator[Play][clientbound][40] = func() Packet { return &Entity{} }
	packetCreator[Play][clientbound][41] = func() Packet { return &VehicleMove{} }
	...
	packetCreator[Play][clientbound][64] = func() Packet { return &Passengers{} }
	packetCreator[Play][clientbound][65] = func() Packet { return &Teams{} }
	packetCreator[Play][clientbound][66] = func() Packet { return &UpdateScore{} }
	packetCreator[Play][clientbound][67] = func() Packet { return &SpawnPosition{} }
	packetCreator[Play][clientbound][68] = func() Packet { return &TimeUpdate{} }
	packetCreator[Play][clientbound][69] = func() Packet { return &Title{} }
	packetCreator[Play][clientbound][70] = func() Packet { return &HardSoundEffect{} }
	packetCreator[Play][clientbound][71] = func() Packet { return &PlayerListHeaderFooter{} }
	packetCreator[Play][clientbound][72] = func() Packet { return &CollectItem{} }
	packetCreator[Play][clientbound][73] = func() Packet { return &EntityTeleport{} }
	packetCreator[Play][clientbound][74] = func() Packet { return &EntityProperties{} }
	packetCreator[Play][clientbound][75] = func() Packet { return &EntityEffect{} }
}
