...
func (t *TeleConfirm) write(ww io.Writer) (err error) {
	if err = WriteVarInt(ww, t.ID); err != nil {
		return
	}
	return
}
func (t *TeleConfirm) read(rr io.Reader) (err error) {
	if t.ID, err = ReadVarInt(rr); err != nil {
		return
	}
	return
}
...
func (s *SteerBoat) write(ww io.Writer) (err error) {
	if err = WriteBool(ww, s.Right); err != nil {
		return
	}
	if err = WriteBool(ww, s.Left); err != nil {
		return
	}
	return
}
func (s *SteerBoat) read(rr io.Reader) (err error) {
	if s.Right, err = ReadBool(rr); err != nil {
		return
	}
	if s.Left, err = ReadBool(rr); err != nil {
		return
	}
	return
}
...
func init() {
	packetCreator[Play][serverbound][0] = func() Packet { return &TeleConfirm{} }
	packetCreator[Play][serverbound][1] = func() Packet { return &TabComplete{} }
	packetCreator[Play][serverbound][2] = func() Packet { return &ChatMessage{} }
	packetCreator[Play][serverbound][3] = func() Packet { return &ClientStatus{} }
	packetCreator[Play][serverbound][4] = func() Packet { return &ClientSettings{} }
	packetCreator[Play][serverbound][5] = func() Packet { return &ConfirmTransactionServerbound{} }
	packetCreator[Play][serverbound][6] = func() Packet { return &EnchantItem{} }
	packetCreator[Play][serverbound][7] = func() Packet { return &ClickWindow{} }
	packetCreator[Play][serverbound][8] = func() Packet { return &CloseWindow{} }
	packetCreator[Play][serverbound][9] = func() Packet { return &PluginMessageServerbound{} }
	packetCreator[Play][serverbound][10] = func() Packet { return &UseEntity{} }
	packetCreator[Play][serverbound][11] = func() Packet { return &KeepAliveServerbound{} }
	packetCreator[Play][serverbound][12] = func() Packet { return &PlayerPosition{} }
	packetCreator[Play][serverbound][13] = func() Packet { return &PlayerPositionLook{} }
	packetCreator[Play][serverbound][14] = func() Packet { return &PlayerLook{} }
	packetCreator[Play][serverbound][15] = func() Packet { return &Player{} }
	packetCreator[Play][serverbound][16] = func() Packet { return &VehicleDrive{} }
	packetCreator[Play][serverbound][17] = func() Packet { return &SteerBoat{} }
	packetCreator[Play][serverbound][18] = func() Packet { return &ClientAbilities{} }
	packetCreator[Play][serverbound][19] = func() Packet { return &PlayerDigging{} }
	packetCreator[Play][serverbound][20] = func() Packet { return &PlayerAction{} }
	packetCreator[Play][serverbound][21] = func() Packet { return &SteerVehicle{} }
	packetCreator[Play][serverbound][22] = func() Packet { return &ResourcePackStatus{} }
	packetCreator[Play][serverbound][23] = func() Packet { return &HeldItemChange{} }
	packetCreator[Play][serverbound][24] = func() Packet { return &CreativeInventoryAction{} }
	packetCreator[Play][serverbound][25] = func() Packet { return &SetSign{} }
	packetCreator[Play][serverbound][26] = func() Packet { return &ArmSwing{} }
	packetCreator[Play][serverbound][27] = func() Packet { return &SpectateTeleport{} }
	packetCreator[Play][serverbound][28] = func() Packet { return &PlayerBlockPlacement{} }
	packetCreator[Play][serverbound][29] = func() Packet { return &UseItem{} }
}
